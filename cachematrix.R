...
# 1) resetmatrix , which basically sets the matrix to that received 
...
# 4) getinverse, returns the inverseval , which could be the cached, 
...
makeCacheMatrix <- function(x = matrix()) 
    ...
    }                                  # held in a scope beyond the confines
                                       # of the function, meaning it is 
                                       # available to other session functions
    getmatr <- function() x            
